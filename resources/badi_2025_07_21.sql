...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-07-2025 a las 18:34:37
...
(27, 17, 17, 3, 'Antonio Ante', 'urbano', 127, '12', '12', 168, 172, 176, 181, 12, 187, 191, 196, 12, 127, 12, 12, 12, 0, 0, 0, 0, 217, 222, 12, 'Ninguno', 'Ninguno', 0, 0, 12, 0, 'Observaciones de prueba .......', NULL, 0, '2025-07-18 23:06:17', '2025-07-18 23:06:17'),
...
(29, 17, 19, 2, 'Tulcán', 'urbano', 141, '123', '123', 168, 172, 176, 181, 12, 188, 194, 196, 12, 127, 12, 12, 12, 0, 0, 0, 0, 217, 222, 0, 'Ninguno', 'Ninguno', 0, 0, 12, 0, 'dfsdfsdfsdf', NULL, 0, '2025-07-18 23:11:52', '2025-07-18 23:11:52'),
...
(32, 17, 23, 2, 'Tulcán', 'urbano', 141, 'sdfsdf', 'sdfsdf', 168, 173, 176, 181, 2, 187, 191, 196, 45, 127, 5, 5, 5, 0, 5, 0, 5, 217, 222, 5, 'Ninguno', 'Ninguno', 0, 0, 2, 0, 'Los gastos exceden al ingreso mensual y no se detectan vehículos con estado regular o bueno', 'Aprobado', 1, '2025-07-21 11:14:50', '2025-07-21 11:14:50'),
(33, 18, 25, 2, 'Bolívar', 'urbano', 150, 'Comunidad Ejemplo', 'Barrio ejemplo', 169, 172, 176, 182, 2, 188, 191, 197, 90, 127, 12, 12, 12, 0, 12, 0, 12, 217, 223, 12, 'Ninguno', 'Ninguno', 0, 0, 2, 0, 'Los gastos exceden al ingreso mensual y no se detectan vehículos con estado regular o bueno', 'Aprobado', 1, '2025-07-21 11:27:40', '2025-07-21 11:27:40');
...
--
ALTER TABLE `tbl_datos_generales`
  MODIFY `id_datos_generales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `tbl_datos_generales_parentesco`
--
ALTER TABLE `tbl_datos_generales_parentesco`
  MODIFY `id_datos_generales_parentesco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `tbl_datos_parentesco`
--
ALTER TABLE `tbl_datos_parentesco`
  MODIFY `id_datos_parentesco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tbl_user_rol`
  MODIFY `id_users_rol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
