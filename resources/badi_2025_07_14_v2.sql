...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-07-2025 a las 19:25:18
...
(14, 'asd', 'asd', '123', '123', 237, 242, 246, '2025-07-10', 12, 252, 1, '12', 'Sí', '12', 12.00, '123', 1);
...
(17, 'John', 'johndoe', 'Doe', '1002003020', 'johndoe@mail.com', '090200320', '2025-07-10', NULL, '$2y$10$jYh4/hjAIuj87OmIYk21A.sJ.hH2ZYLj44x28l6y7WQfOBAkbxhjK', 1, NULL, NULL, NULL, NULL, '2025-07-14 11:35:10');
...
--
ALTER TABLE `tbl_funcionalidad`
  MODIFY `id_funcionalidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_rol_access`
  MODIFY `id_principal_rol_access` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
