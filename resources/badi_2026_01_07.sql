...
--
ALTER TABLE `tbl_datos_generales`
  MODIFY `id_datos_generales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT for table `tbl_datos_generales_parentesco`
--
ALTER TABLE `tbl_datos_generales_parentesco`
  MODIFY `id_datos_generales_parentesco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT for table `tbl_datos_parentesco`
--
ALTER TABLE `tbl_datos_parentesco`
  MODIFY `id_datos_parentesco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
