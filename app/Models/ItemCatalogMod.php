...
class ItemCatalogMod extends Model
{
    ...
    public function obtainActiveProvinces()
    {
        return $this->select('
        ...
        ')
            ...
            ->where('tbl_catalogo.cat_codigo', 'PROV')
            ->where('tbl_catalogo.ca_estado', 1)
            ->where('tbl_item_catalogo.itc_estado', 1)
            ->findAll();
    }

    public function obtainActiveCities()
    {
        return $this->select('
            tbl_item_catalogo.id_item,
            tbl_item_catalogo.itc_codigo,
        ...
        ')
            ->join('tbl_catalogo', 'tbl_catalogo.id_catalogo = tbl_item_catalogo.id_catalogo')
            ->where('tbl_catalogo.cat_codigo', 'CANT')
            ->where('tbl_catalogo.ca_estado', 1)
            ->where('tbl_item_catalogo.itc_estado', 1)
            ->findAll();
    }

    public function obtainActiveParishes()
    {
        return $this->select('
            tbl_item_catalogo.id_item,
            tbl_item_catalogo.itc_codigo,
        ...
        ')
            ->join('tbl_catalogo', 'tbl_catalogo.id_catalogo = tbl_item_catalogo.id_catalogo')
            ->where('tbl_catalogo.cat_codigo', 'PARR')
            ->where('tbl_catalogo.ca_estado', 1)
            ->where('tbl_item_catalogo.itc_estado', 1)
            ->findAll();
    }
